...
public class Paginas {
        ...
        // Otra cabecera
        // La cabecera Server se utiliza para informar al cliente sobre el tipo de servidor web que está respondiendo a la solicitud. Por ejemplo, muchos servidores como Apache o NGINX devuelven esta cabecera para indicar su versión.

        public static final String segundaCabecera = "Server: MiServidorHTTP/1.0";
        
        
        public static final String cabeceraDate = "Date:" + ZonedDateTime.now().format(DateTimeFormatter.RFC_1123_DATE_TIME);
