...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Object[] resultado = cifrarFichero("src/Cifrado_ClavePrivadaAES/fichero.txt");
            ...
            descifrarFichero("src/Cifrado_ClavePrivadaAES/fichero.txt.cifrado", clave, iv, "src/Cifrado_ClavePrivadaAES/fichero.descifrado");
